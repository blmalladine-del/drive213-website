...
const purposeDefs = [
  { id: 'wedding', cat: 'wedding', titleKey: 'occasion.wedding' as const, descKey: 'occasion.weddingDesc' as const, icon: Heart, image: '/images/rental-categories/wedding.jpg' },
  { id: 'family', cat: 'family-trips', titleKey: 'occasion.family' as const, descKey: 'occasion.familyDesc' as const, icon: Users, image: '/images/rental-categories/dat.jpg' },
  { id: 'business', cat: 'business-travel', titleKey: 'occasion.business' as const, descKey: 'occasion.businessDesc' as const, icon: Briefcase, image: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=800&q=80' },
  { id: 'airport', cat: 'airport-pickup', titleKey: 'occasion.airport' as const, descKey: 'occasion.airportDesc' as const, icon: Plane, image: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80' },
  { id: 'adventure', cat: 'weekend-escape', titleKey: 'occasion.weekend' as const, descKey: 'occasion.weekendDesc' as const, icon: Mountain, image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80' },
];
...
export function RentalPurposes({ heroImageUrl, businessName }: RentalPurposesProps) {
  ...
  const purposes = purposeDefs.map((p) => ({
    ...p,
    title: t(p.titleKey, locale),
    description: t(p.descKey, locale),
  }));
      ...
      <div className="md:hidden">
        ...
        <div className="px-6 pb-16 pt-10">
          ...
          <h2 className="text-3xl font-bold leading-[1.1] tracking-tight text-white">
            {t('occasion.heading1', locale)} <span className="text-amber-400">{t('occasion.heading2', locale)}</span>
          </h2>
